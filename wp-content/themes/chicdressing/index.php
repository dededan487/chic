...
if ( is_home() ) {
	...
	<div id="chic-products"  class="boxed-wrapper clear-fix">
		<h2 class="chic-title">Les dernières pièces de marque de luxe </h2>
		<?php
		echo do_shortcode('[products orderby="date" columns="3" order="ASC"]');
		?>
		<p class="text-center"><a class="chic-bouton" href="chic_Dressing/shop/">Voir toute la collection de pièces de créateur</a></p>
	</div>
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">prix cassés pour La FashionMap - été 2022 </h2>
		<iframe title="fashionweek-map" src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" width="100%" height="480"></iframe>
	</div>
	<?php 
