...
<div class="main-container">
	...
	echo '<h2 id="leblog" class="chic-title">Dernières publications sur les marques de luxe </h2>';
		...
		while ( have_posts() ) :
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
				...
				<div class="post-media">
					<a href="<?php echo esc_url( get_permalink() ); ?>"aria-label="la mode de chicdressing"></aria-label>></a>
				...
				<header class="post-header">
					...
					<h2 class="post-title">
						<a href="<?php  esc_url( the_permalink() ); ?>"aria-label="la mode de chicdressing"><?php the_title(); ?></a>
					</h2>
					<?php endif; ?>
				...
				<div class="read-more">
					<a href="<?php echo esc_url( get_permalink() ); ?>"aria-label="la mode de chicdressing"><?php esc_html_e( 'read more','ashe' ); ?></a>
				</div>
				...
				<footer class="post-footer">
					...
					<span class="post-author">
						<a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) )); ?>"aria-label="la mode de chicdressing">
	...
	echo '</ul>';
	echo '<p class="text-center"><a class="chic-bouton" href="/chic_dressing"aria-label="la mode de chicdressing">Voir tous les articles</a></p>';
